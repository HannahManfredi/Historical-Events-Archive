# Basic Requirements
* Build a single-page app that enables users to search and browse historical event information based on data found in the
* JSON file included with this repo. Use:
